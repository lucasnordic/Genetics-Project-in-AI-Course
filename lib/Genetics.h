...
class Genetics {
	static const int MAX_GEN = 1000;			// default 300
	...
	static const int MPCS_PER_MUT = 6;			// default 3   ;how many MPC's happen for each mutation
	static const int INIT_MUTATIONS = M_CI*20;  // default M_CI*20 ;N mutations on initial pop
	static const int CHILD_MUT = 1;				// default 1   ;gene mut for each mutating child chrom, each gen
